...
<body>
    ...
    <main>
        ...
        <?php if (isset($_GET['mensagem'])): ?>
            ...
            <?php elseif ($_GET['mensagem'] === 'POSSUI_INSCRICOES'): ?>
                ...
                <div class="alert alert-warning alert-dismissible fade show" role="start">
                    Não é possivel excluir esta atividade, pois existem inscrições
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-8 col-lg-6">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="mb-3">
                            <label for="local_atividade" class="form-label">Local:</label>
        ...
        <section class="mb-5">
            ...
            <h2 class="mb-4 text-center">Atividades Cadastradas</h2>
    ...
    <footer>
        <h4>Festival Experiência Viva</h4>
    </footer>
